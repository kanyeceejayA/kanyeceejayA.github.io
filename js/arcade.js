...
(function () {
  ...
  function build() {
    ...
    dlg.addEventListener('keydown', function (e) {
      ...
      if (n >= 1 && n <= GAMES.length) { e.preventDefault(); start(GAMES[n - 1].id); }
    });
  }
  ...
  function showPicker() {
    ...
    body.innerHTML = '<p class="arcade-intro">Three small games, all set in Kampala. Pick one.</p><div class="arcade-cards"></div>';
    ...
    api.setHelp(touchy() ? 'Tap a game to play.' : 'Click a game, or press 1, 2 or 3.');
